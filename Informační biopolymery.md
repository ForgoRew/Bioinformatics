...
# 12 Kolorimetrie a hmotnostní spektrometrie
...
+ pomocí ionizace
  ...
  + ...
+ výstupy jsou v jednotkách `m/z`, hmota na náboj
+ spektra základních látek se dají najít v databázy
+ spektra proteinů jsou trochu šílená
+ pomocí fragmentace
  + proteiny je možné rozštěpit na fragmenty
  + fragmenty je možné ohledávat a porovnávat s databází

## Krystalografie proteinů
+ získání co nejčistšího proteinu
